...
```{r include=FALSE Create Sample Table}
...
A common problem is determining the unique values of a categorical variable. The code chunk below demonstrates how to do this using the `reframe()` and `unique()` functions. An alternative way to do this is shown in the next sectio using the `group_by()` and `summarize()` functions. 
